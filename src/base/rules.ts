...
const unicornRules = {
  ...
  'unicorn/consistent-function-style': ['off'], // Handled by func-style
  ...
  'unicorn/no-useless-concat': ['off'], // Handled by no-useless-concat
  ...
  'unicorn/no-useless-template-literals': ['off'], // Handled by @typescript-eslint/no-unnecessary-template-expression
  ...
  'unicorn/operator-assignment': ['off'], // Handled by operator-assignment
  ...
  'unicorn/prefer-short-arrow-method': ['off'], // Conflicts with object-shorthand
...
const e18eRules = {
  ...
  'e18e/prefer-array-from-map': ['off'], // Handled by unicorn/prefer-array-from-map
