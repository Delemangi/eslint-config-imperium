...
const eslintSuggestionsRules = {
  ...
  'no-lonely-if': ['error'],
  'no-loop-func': ['error'],
  'no-magic-numbers': ['error', { enforceConst: true, ignore: [0, 1], ignoreClassFieldInitialValues: true, ignoreDefaultValues: true }], // Should this be enabled?
...
const unicornRules = {
  ...
  'unicorn/no-process-exit': ['off'], // Revisit this rule
  ...
  'unicorn/prefer-code-point-at': ['error'],
